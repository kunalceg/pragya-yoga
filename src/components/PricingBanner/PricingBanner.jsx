    ...
    <div className={styles.grid}>
      <article className={styles.card}>
        ...
        <p className={styles.cardDesc}>
          Unlimited yoga classes and meditation sessions. Perfect for beginners
        ...
        <a href="/membership/monthly" className={styles.btnPrimary}>
      ...
      <article className={styles.card}>
        ...
        <p className={styles.cardDesc}>
          Save 20% and enjoy exclusive workshops. Best value for dedicated
          seekers of holistic wellness.
        </p>
        <ul className={styles.cardBenefits}>
          <li>Unlimited classes</li>
        ...
        <a href="/membership/annual" className={styles.btnPrimary}>
          Start 7-Day Free Trial →
        </a>
      </article>
    </div>
