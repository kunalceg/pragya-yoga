      ...
      <div className={styles.content}>
        <article className={styles.card}>
          ...
          <p className={styles.cardDesc}>
            Practices rooted in Bharat's yogic tradition — Asanas, Pranayama,
            and Dhyana — passed down with integrity and respect.
          </p>
        </article>
        ...
        <article className={styles.card}>
          ...
          <p className={styles.cardDesc}>
            Supported by modern research on stress reduction, flexibility, and
            holistic health, making yoga relevant for today's lifestyle.
          </p>
        </article>
        ...
        <article className={styles.card}>
          ...
          <p className={styles.cardDesc}>
            Connecting communities worldwide, sharing India's wellness heritage,
            and promoting balance of mind, body, and spirit.
          </p>
        </article>
      </div>
    </div>
